...
<form id="registerMotherForm" method="post">

<fieldset id="registerMotherdetails" >
...
<p>
 ...
 <p>
   ${ ui.includeFragment("uicommons", "field/text", [ "id": "parity", "label": "Parity","formFieldName": "parity" ])}
 </p>
