 ...
 */
package org.openmrs.module.birthnotification2.api;
...
import org.openmrs.module.birthnotification2.Birthnotification2Config;
 ...
 */
public interface Birthnotification2Service extends OpenmrsService {
	
	@Authorized(Birthnotification2Config.MODULE_PRIVILEGE)
	@Transactional
